                                ...
                                <table id="basic-table" class="data-table table table-striped nowrap table-hover table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            <td> <img src="../images/books/<?=$row['book_image']?>" width="100" height="100"> </td>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <form method="post" action="">
                                        ...
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary" name="update_book"> <i class="fa fa-save"></i>Update Info</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
