...
$data=mysqli_query($con,"SELECT * FROM librarian WHERE email='$librarian_login' || username='$librarian_login'");
                ...
                <div class="header-section" id="user-headerbox">
                    ...
                    <div class="user-options dropdown-box">
                        <div class="drop-content basic">
                            <ul>
                                <li> <a href="index.php"><i class="fa fa-user" aria-hidden="true"></i> Profile</a></li>
