...
$data=mysqli_query($con,"SELECT * FROM students WHERE email='$student_login' || username='$student_login'");
        ...
        <div class="page-header">
            ...
            <div class="rightside-header">
                ...
                <div class="header-section" id="user-headerbox">
                    <div class="user-header-wrap">
                        <div class="user-photo">
                            <img alt="profile photo" src="../assets/images/rashed1.jpg" />
                        </div>
                    ...
                    <div class="user-options dropdown-box">
                        <div class="drop-content basic">
                            ...
                            <ul>
                                <li> <a href="student-profile.php?id=<?=$student_info['id']?>"><i class="fa fa-user" aria-hidden="true"></i> Profile</a></li>
                ...
                <div class="header-section">
                    <a href="logout.php" data-toggle="tooltip" onclick="return confirm('Are you sure to Logout?');" data-placement="left" title="Logout"><i class="fa fa-sign-out log-out" aria-hidden="true"></i></a>
                </div>
            </div>
        </div>
        <!-- page BODY -->
                        ...
                        <nav>
                            <ul class="nav nav-left-lines" id="main-nav">
                                ...
                                <li class="<?= $page=='index.php' ? 'active-item':''?>"><a href="index.php"><i class="fa fa-home" aria-hidden="true"></i><span>Dashboard</span></a></li>
                                 <li class="<?= $page=='books.php' ? 'active-item':''?>"><a href="books.php"><i class="fa fa-books" aria-hidden="true"></i><span>Books</span></a></li>
                                <!--UI ELEMENTENTS-->
